...
extension cglm
{
	 ...
	 * @param[in]     col2 col2
	 */
	[CLink] public static extern void glm_mat2_swap_col(mat2 mat, int col1, int col2);
	 ...
	 * @param[in]     row2 row2
	 */
	[CLink] public static extern void glm_mat2_swap_row(mat2 mat, int row1, int row2);
